...
# cp clang_stuff/CMakeLists_patched $path_to_llvm_project/clang-tools-extra/CMakeLists.txt
# cp clang_stuff/extract-comments_CMakeLists.txt $path_to_llvm_project/clang-tools-extra/$name_of_tool/CMakeLists.txt
cp clang_stuff/ExtractComments.cpp $path_to_llvm_project/clang-tools-extra/$name_of_tool/$tool_cpp
# cp clang_stuff/ASTContext.h_patched $path_to_llvm_project/clang/include/clang/AST/ASTContext.h
